...
public class RegRecActivity extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reg_rec);
        ...
        //1.data 준비
//        Myitem p1 = new Myitem(R.mipmap.ic_launcher,"등록","http://m.naver.com/","2800");
//        Myitem p2 = new Myitem(R.mipmap.ic_launcher_round,"된","http://m.kakao.com","3000");
//        Myitem p3 = new Myitem(R.mipmap.ic_launcher_round,"음식기반","http://www.seoul.kr","333");
...
//        plist.add(p3);
    ...
    public String selectDataMember(){
        String q = "select* from member2 order by _name";
